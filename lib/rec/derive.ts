 ...
 *
 * Pure, and free of the database on purpose: the offline builders import it,
 * and anything marked server-only cannot be imported by a script.
 */
 ...
 */
export function deriveProfile(film: DeriveRow): Vector {
...
/** The columns the derivation reads, so callers can select exactly them. */
